namespace MagicalNuts.IncrementalTextBoxSample
{
	partial class Form1
	{
		...
		{
			this.incrementalTextBox1 = new MagicalNuts.IncrementalTextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.textBox1 = new System.Windows.Forms.TextBox();
			this.incrementalTextBox2 = new MagicalNuts.IncrementalTextBox();
			this.incrementalTextBox3 = new MagicalNuts.IncrementalTextBox();
			this.SuspendLayout();
			// 
			// incrementalTextBox1
			// 
			...
			this.incrementalTextBox1.Decided += new MagicalNuts.IncrementalTextBox.IncrementalTextBoxEventHandler(this.incrementalTextBox1_Decided);
			// 
			// label1
			// 
		...
		private MagicalNuts.IncrementalTextBox incrementalTextBox1;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.TextBox textBox1;
		private MagicalNuts.IncrementalTextBox incrementalTextBox2;
		private MagicalNuts.IncrementalTextBox incrementalTextBox3;
	}
}
